                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-header border-bottom text-center">
                                <div class="mb-3 mx-auto">
                                    <a href="/{{ request()->slug_instalacion }}/admin/users/{{ $user->id }}/cambiar-foto"
                                        style="opacity: 1">
                                        <img class="rounded-circle" src="{{ asset('img/assets/user-default.png') }}"
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    ...
                                    @if ($user->date_birth)
                                        <li class="list-group-item px-4"><strong>Fecha de nacimiento:</strong>
                                            {{ $user->date_birth }}</li>
                                    @endif
                                    @if ($user->tlfno)
                                    ...
                                    @endif
                                    <li class="list-group-item px-4"><strong>Fecha de alta:</strong>
                                        {{ date('d/m/Y', strtotime($user->aprobado)) }}</li>
                                    <li class="list-group-item px-4"><strong>Baja:</strong>
                                        {{ $user->deleted_at ?? 'Cliente activo' }}</li>
                                    <li class="list-group-item px-4"><strong>Codigo postal:</strong>
                                        {{ $user->postal_code }}</li>
                                    <li class="list-group-item px-4"><strong>Localidad:</strong> {{ $user->city }}</li>
                                    <li class="list-group-item px-4"><strong>Canal publicitario:</strong>
                                        {{ $user->canal_publicitario }}</li>
                                    <li class="list-group-item px-4"><strong>Datos deportivos:</strong>
                                        {{ $user->datos_deportivos }}</li>
                                    <li class="list-group-item px-4"><strong>Notas generales:</strong>
                                        {{ $user->notas_generales }}</li>
                                    <li class="list-group-item px-4"><strong>estado:</strong> {{ $user->estado }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($user->reservas as $item)
                                            <tr>
                                                ...
                                                <td>{{ count(auth()->user()->instalacion->deportes) > 1 ? $item->pista->tipo . '.' : '' }}
                                                    {{ $item->pista->nombre }}</td>
                                                <td>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form
                                    action="/{{ request()->slug_instalacion }}/admin/users/{{ $user->id }}/update-maximas-reservas"
                                    method="post">
                                    @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <a href="/{{ request()->slug_instalacion }}/admin/users/{{ request()->id }}/cobro/add"
                                    class="btn btn-primary">Añadir cobro</a>
                                    ...
                                    <tbody>
                                        @foreach ($user->cobros as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->forma }}</td>
                                                <td>{{ $item->cantidad }} €</td>
                                                <td><a href="/{{ request()->slug_instalacion }}/admin/cobro/{{ $item->id }}"
                                                        class="btn btn-primary"><i class="fas fa-edit"></i></a> <a
                                                        href="/{{ request()->slug_instalacion }}/admin/cobro/{{ $item->id }}/delete"
